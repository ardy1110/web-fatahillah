  ...
  return (
    ...
    <main className="flex flex-col h-dvh py-12">
      ...
      <footer className="absolute bottom-0 left-0 w-full flex justify-center">
        <div className="relative p-3 m-4 rounded-2xl shadow-lg inline-flex items-center justify-center gap-4 px-10 overflow-hidden backdrop-blur-md bg-amber-600/40 border border-white/20">
